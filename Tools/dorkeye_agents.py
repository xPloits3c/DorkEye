...
# FIX #1: dunder mangling da copia/incolla (**future** → __future__)
...
class _ScriptStyleStripper(_HTMLParser):
    ...
    del tag di chiusura (es. </script  >, </SCRIPT\n>, ecc.).
    """
...
# FIX #3: * → _ (naming error da copia/incolla)
...
class EmailHarvesterAgent(BaseAgent):
    ...
    def __init__(self, plugin=None):
        ...
        self._global_emails: Dict[str, dict] = {}
