...
## What is DorkEye
**DorkEye** DorkEye is an advanced and automated python script for Google Dorking to identify exposed web resources using Open Source Intelligence techniques.
